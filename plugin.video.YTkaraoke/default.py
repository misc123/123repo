...
def main_list(params):
    ...
    plugintools.add_item( 
        ...
        url="plugin://plugin.video.youtube/channel/UCwTRjvjVge51X-ILJ4i22ew"+ID3+"/",
    ...
    plugintools.add_item( 
        ...
        url="plugin://plugin.video.youtube/channel/UCnM6QQeanPgBRyEMeFmrNnA"+ID4+"/",
    ...
    plugintools.add_item( 
        ...
        url="plugin://plugin.video.youtube/playlist/PL85FA0BC339A2D54A"+ID5+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="Golden Oldies",
        url="plugin://plugin.video.youtube/playlist/PL5731F33837BC5BBF"+ID6+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="50s 60s 70s",
        url="plugin://plugin.video.youtube/playlist/PLNVb4XeGx1kJD3Md0xJQIUv8l7z9u3_-Z"+ID7+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="70s 80s",
        url="plugin://plugin.video.youtube/playlist/PL86C45E6B701AD75F"+ID8+"/",
    ...
    plugintools.add_item( 
        ...
        url="plugin://plugin.video.youtube/channel/UCjCBQdXHbIJ_u2Wm-WMb9ow"+ID9+"/",
    ...
    plugintools.add_item( 
        ...
        url="plugin://plugin.video.youtube/playlist/PL96CED83AA24CE6DD"+ID10+"/",
    ...
    plugintools.add_item( 
        ...
        url="plugin://plugin.video.youtube/channel/UCOWgg92ii_Kvakk1HwTmdmg"+ID11+"/",
