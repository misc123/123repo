...
ADDONID = 'plugin.video.supershortcuts'
ADDON   =  xbmcaddon.Addon(ADDONID)
HOME    =  ADDON.getAddonInfo('path')
ROOT    =  ADDON.getSetting('FOLDER')
PROFILE =  os.path.join(ROOT, 'Super Shortcuts')
VERSION = '1.0.18'
...
def WriteKeymap(start, end):
    dest = os.path.join(xbmc.translatePath('special://profile/keymaps'), KEYMAP_HOT)
    cmd  = '<keymap><Global><keyboard><%s>XBMC.RunScript(special://home/addons/plugin.video.supershortcuts/hot.py)</%s></keyboard></Global></keymap>'  % (start, end)
