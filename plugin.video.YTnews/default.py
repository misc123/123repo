...
def main_list(params):
    ...
    plugintools.add_item( 
        #action="", 
        title="News3600",
        url="plugin://plugin.video.youtube/channel/UCZcmbs2ibTC0Aeur-0_qBDQ"+ID2+"/",
        thumbnail="https://yt3.ggpht.com/-WqTXqXBRXhM/AAAAAAAAAAI/AAAAAAAAAAA/vhm-oxD2VXY/s100-c-k-no-mo-rj-c0xffffff/photo.jpg",
        folder=True )
    ...
    plugintools.add_item( 
        #action="", 
        title="加拿大国家电视台直播",
        url="plugin://plugin.video.youtube/search/?q=%e5%8a%a0%e6%8b%bf%e5%a4%a7%e5%9b%bd%e5%ae%b6%e7%94%b5%e8%a7%86%e5%8f%b0%e7%9b%b4%e6%92%ad"+ID6+"/",
    ...
    plugintools.add_item( 
        ...
        url="plugin://plugin.video.youtube/search/?q=%e5%8a%a0%e5%9c%8b%e6%96%b0%e8%81%9e-MiTV&amp;search_type=channel"+ID7+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="多倫多 WOWtv",
        url="plugin://plugin.video.youtube/channel/UC5kySUzP0p4Q4Y1rnQLX_bw"+ID8+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="蕭若元：海外蕭析",
        url="plugin://plugin.video.youtube/channel/UCu_YquoQYKR3GpP82TO-zRw/playlist/PLPY0_ooDN1dt3hMVPJbGEag_5_DCMPwFu"+ID9+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="蕭若元：香港商界十大梟雄",
        url="plugin://plugin.video.youtube/channel/UCJQ-REbY-IfisGatyrWfVNg/playlist/PLLPBrSaE8CCtxOiyLsV7BsQVH3RCnLELB"+ID10+"/",
        thumbnail="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcSaLz_W0D6UR_z8HS3vRSYAcFAmyKEIw2RBWkWku6p0YAWUKPHB5EOxXtw",
        folder=True )
    ...
    plugintools.add_item( 
        #action="", 
        title="蕭若元：最新蕭析",
        url="plugin://plugin.video.youtube/playlist/PLPY0_ooDN1dvClKgo7K1tAS26PeAHmikd"+ID11+"/",
        thumbnail="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcSaLz_W0D6UR_z8HS3vRSYAcFAmyKEIw2RBWkWku6p0YAWUKPHB5EOxXtw",
        folder=True )
    ...
    plugintools.add_item( 
        #action="", 
        title="東網直播",
        url="plugin://plugin.video.youtube/search/?q=%e6%9d%b1%e7%b6%b2%e7%9b%b4%e6%92%ad"+ID12+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="巴士的報",
        url="plugin://plugin.video.youtube/channel/UCCBNE0MbFaSooy7ZhJwXSrg"+ID13+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="頭條日報",
        url="plugin://plugin.video.youtube/user/hkheadlinenews"+ID14+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="蘋果動新聞",
        url="plugin://plugin.video.youtube/channel/UCeqUUXaM75wrK5Aalo6UorQ"+ID15+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="壹週Plus",
        url="plugin://plugin.video.youtube/channel/UC-8CVMKt5Zlju_i07zhkC-Q"+ID16+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="E週刊",
        url="plugin://plugin.video.youtube/channel/UCeFbWIhDj_tjTOTe1P3cVHA"+ID17+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="東Touch",
        url="plugin://plugin.video.youtube/user/EastTOUCHhk"+ID18+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="東周網",
        url="plugin://plugin.video.youtube/channel/UCsTeCS6s9YoNn2kbQVAgDsQ"+ID19+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="東網電視",
        url="plugin://plugin.video.youtube/channel/UC4NjmIegGw-HyQCmxwAEZBQ"+ID20+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="恩雨之聲",
        url="plugin://plugin.video.youtube/channel/UCgwOhn9ghL2jY5qJEzpzSzw"+ID21+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="RTHK 香港電台",
        url="plugin://plugin.video.youtube/channel/UC6of7UYhctnYmqABjUqzuxw/playlists"+ID22+"/",
