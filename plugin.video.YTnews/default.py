...
def main_list(params):
    ...
    plugintools.add_item( 
        #action="", 
        title="最新蕭析",
        url="plugin://plugin.video.youtube/playlist/PLPY0_ooDN1dvClKgo7K1tAS26PeAHmikd"+ID5+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="東網直播",
        url="plugin://plugin.video.youtube/play/?video_id=WrkVwCYvRPk"+ID7+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="耀才財經台－現場直播",
        url="plugin://plugin.video.youtube/search/?q=%e8%80%80%e6%89%8d%e8%b2%a1%e7%b6%93%e7%9b%b4%e6%92%ad"+ID8+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="港股策略王",
        url="plugin://plugin.video.youtube/channel/UChHUArghghtyM5zTMkxmi_Q"+ID9+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="財華社現代電視",
        url="plugin://plugin.video.youtube/user/FintvVideo"+ID10+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="巴士的報",
        url="plugin://plugin.video.youtube/channel/UCCBNE0MbFaSooy7ZhJwXSrg"+ID11+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="頭條POPNews",
        url="plugin://plugin.video.youtube/user/headlinepopnews"+ID12+"/",
    ...
    plugintools.add_item( 
        #action="", 
        title="多倫多 WOWtv",
        url="plugin://plugin.video.youtube/channel/UC5kySUzP0p4Q4Y1rnQLX_bw"+ID22+"/",
